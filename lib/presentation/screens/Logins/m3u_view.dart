            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    _buildTabButton('M3U', isM3USelected, () => setState(() => isM3USelected = true)),
                    _buildTabButton('Xtream', !isM3USelected, () => setState(() => isM3USelected = false)),
                  ],
                ),
              ),
              SizedBox(height: 40.h),
              _buildInputField('Playlist Name', playlistNameController),
              SizedBox(height: 20.h),
              _buildInputField('M3U URL', m3uUrlController),
              if (!isM3USelected) ...[
  ...
  Widget _buildInputField(String label, TextEditingController controller) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(label, style: getMediumTextStyle(color: const Color(0xffD6D6D6), fontSize: 14.sp)),
          SizedBox(height: 10.h),
          CustomTextFormField(
