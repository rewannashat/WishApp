                        ...
                        itemBuilder: (context, index) {
                          return Column(
                            children: [
                              GestureDetector(
                                onTap: (){
                                  NormalNav(ctx: context , screen: MovieDetailScreen(index: index,));
                                },
                                child: Stack(
                                  children: [
                                    Container(
                                    ...
                                    Positioned(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          context.read<MovieCubit>().toggleFavorite(index);
                                          toast(
                                            msg: context.read<MovieCubit>().state.contains(index)
                                                ? 'Added to favorites'
                                        ...
                                        child: Container(
                                            ...
                                            child: BlocBuilder<MovieCubit, Set<int>>(
